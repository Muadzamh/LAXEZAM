...
public final class FragmentDetectionBinding implements ViewBinding {
  ...
  private FragmentDetectionBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextView tvEstimatedWeight, @NonNull TextView tvLidarHeader,
  ...
  public static FragmentDetectionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentDetectionBinding((ConstraintLayout) rootView, cameraPreview, cameraSection,
          lidarSection, mlResultOverlay, tvCameraStatus, tvConfidence, tvConnectionStatus,
          tvDistance, tvEstimatedWeight, tvLidarHeader, tvSignalStrength, tvTemperature,
          tvTimestamp);
    }
